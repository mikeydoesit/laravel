                                ...
                                <div class="card-body">
                                    <form action="#" id="basicform" data-parsley-validate="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="inputItemPrice" type="text" name="itemPrice" data-parsley-trigger="change" required="" placeholder="$0.00" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputItemImageURL">Image URL</label>
                                            <input id="inputItemImageURL" type="text" name="imageURL" data-parsley-trigger="change" required="" placeholder="https://www.billys.com/img/burgers.jpg" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="row">
